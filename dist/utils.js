    ...
    const apis = [
        {
            ...
            parse: (d) => {
                const data = d;
                return Object.fromEntries(Object.entries(data).map(([code, desc]) => [
                    code,
        ...
        },
        {
            ...
            parse: (d) => {
                ...
                const entries = raw["symbols"]
                    ? Object.entries(raw["symbols"])
                    : Object.entries(raw);
                return Object.fromEntries(entries.map(([code, val]) => {
                    const desc = typeof val === "string"
                        ? val
...
export const formatTimestamp = (t) => new Date(t * 1000).toLocaleString("en-US", {
    month: "short",
    day: "numeric",
    year: "numeric",
    hour: "2-digit",
